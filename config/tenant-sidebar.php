...
return [
    'main_menu' => [
        ...
        'marketing_section' => [
            ...
            'label' => 'marketing',
            'icon' => null,
            'permission' => ['tenant.campaigns.view', 'tenant.bulk_campaigns.send', 'tenant.message_bot.view', 'tenant.template_bot.view', 'tenant.bot_flow.view', 'tenant.bot_flow.create'],
            'permission_type' => 'any',
            'order' => 6,
        ...
        'support_section' => [
            ...
            'label' => 'support',
            'icon' => null,
            'permission' => ['tenant.chat.view', 'tenant.tickets.index'],
            'order' => 7,
            'section_id' => 'support',
            'children' => [
                'chat' => [
