                ...
                <x-card class="rounded-lg">
                    ...
                    <x-slot:content>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <!-- Image Alt Text -->
                            <div>
                                <x-label for="image_alt_text" value="Image Alt Text" />
                        ...
                        <div>
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 pt-4">
                                <!-- Primary Button -->
                                <div>
                                    <x-label for="primary_button_text" value="Primary Button Text" />
                                ...
                                <!-- Primary Button Type -->
                                <div wire:ignore>
                                    <x-label for="primary_button_type" value="Primary Button Type" />
                                ...
                                <!-- Primary Button URL -->
                                <div>
                                    <x-label for="primary_button_url" value="Primary Button URL" />
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 pt-4">
                                <!-- Secondary Button -->
                                <div>
                                    <x-label for="secondary_button_text" value="Secondary Button Text" />
                                ...
                                <div wire:ignore>
                                    <x-label for="secondary_button_type" value="Secondary Button Type" />
                                ...
                                <div>
                                    <x-label for="secondary_button_url" value="Secondary Button URL" />
